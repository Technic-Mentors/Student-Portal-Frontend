        ...
        <div id="content">
          ...
          <div className="container-fluid">
            ...
            <div className="row justify-content-end align-items-end mb-1">
              ...
              <Link to="/addquestion" className="viewbtn mb-3">
                  Create Question
                </Link>
            ...
            <div className="col-12">
              <table className="table table-striped admin-table">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>Questions Classes</td>
                    <td>2</td>
                    <td>5</td>
                    <td>7</td>
                    <td>
                      <Link to="/viewquestiondetail" className="tableviewbtn">
                          View
                        </Link>
                        <Link to="/editquestion" className="text-black">
                          Edit
                        </Link>
